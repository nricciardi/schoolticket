<div class="row">
    <div class="col-md-12">
        <!-- DATA TABLE -->
        <h3 class="title-5 m-b-35">Macroaree</h3>
        <div class="table-data__tool">
            <div class="table-data__tool-left">
                ...
                <button type="button" class="btn btn-link" style="color: #6C757D" id="btn_refresh_management_macroarea">
                    <i class="fa fa-refresh"></i>&nbsp; Ricarica</button>
            </div>
            <div class="table-data__tool-right">
                <button class="au-btn au-btn-icon au-btn--green au-btn--small" id="formAddMacroarea">
                    <i class="zmdi zmdi-plus"></i>Nuova macroarea</button>
