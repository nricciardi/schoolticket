<?php
    ...
    class Competenze {
        ...
        public function get($idCompetenza = null, $credenziali = null) {      // opzionale: se viene passato un id, restituisco solo il aula con l'id passato
            ...
            if($idCompetenza === null) {      // se il parametro è null non viene richiesto un aula specifico, restituisco tutte le aule
                ...
                for ($i=0; $i < count($idCompetenza); $i++) { 
                    ...
                    $query .= " schoolticket.aula.IdCompetenza = ?"; 
        ...
        public function delete($idCompetenza = null, $credenziali = null) {      // opzionale: se viene passato un id, eliminino solo il aula con l'id passato
            ...
            if($idCompetenza === null) {      // se il parametro è null non viene richiesto un aula specifico, restituisco errore
        ...
        public function update($aula = null, $credenziali = null) {
            ...
            if(!isset($aula->IdCompetenza) || $this->exist($aula->IdCompetenza) === false)   // se l'id passato non esiste, creo il aula
            ...
            if($aula === null) {      // se il parametro è null non viene richiesto un aula specifico, restituisco errore
                ...
                // creo la query finale da usare 
                $query .= " WHERE schoolticket.aula.IdCompetenza = ?";

                // aggiungo l'id del permesso all'array dei valori
                if(isset($aula->IdCompetenza) && trim($aula->IdCompetenza) != "" && $aula->IdCompetenza != null && is_numeric((int) $aula->IdCompetenza)) {
                    $IdCompetenza = (int) $aula->IdCompetenza;
